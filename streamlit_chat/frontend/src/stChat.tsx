...
class Chat extends StreamlitComponentBase {
  public render = (): ReactNode => {
    const { isUser, avatarStyle, seed, message, avatarSelfHosted } = this.props.args;

    const avatarUrl = avatarSelfHosted ?
      `static/svg/${avatarStyle}/${seed}.svg` :
      `https://avatars.dicebear.com/api/${avatarStyle}/${seed}.svg`
